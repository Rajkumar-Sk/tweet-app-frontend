...
import "../../css/tweetappuser/AllUsers.css";
import { allUsers, getUserByUserName } from "../ApiService";
      ...
      <div>
        ...
        <div className="AllUsersContainer">
          {this.state.userProfile.length > 0 ? (
            this.state.userProfile.reverse().map((user) => (
            ...
            <div className="searchUserText"></div>
          )}
        </div>
      </div>
    );
